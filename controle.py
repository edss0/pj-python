...
def salvar_dados_editados():
    # pega o numero id
    global numero_id
    # valor digitado no lineEdit (QtDesigner)
    ...
    cursor = banco.cursor()
    cursor.execute("UPDATE cadastro SET codigo = '{}', descricao= '{}', preco= '{}', categoria= '{}' WHERE id= {}".format(codigo, descricao, preco, categoria, numero_id))
...
def gerar_pdf():
    ...
    dados_lidos = cursor.fetchall()
    y=0
    pdf = canvas.Canvas("produtos_cadastro.pdf")
...
def funcao_principal():
    ...
    cursor = banco.cursor()
    comando_SQL = "INSERT INTO cadastro (codigo, descricao, preco, categoria) VALUES (%s, %s, %s, %s)"
...
# INSERT INTO cadastro (codigo, descricao, preco, categoria) VALUES (123, "impressora", 500.00, "informatica");
